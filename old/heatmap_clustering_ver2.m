...
%replicate mol list for CropROIs
...
% for 3 color combined .bin file
% otherwise load similarity registered heatmap file
...
[centers_heatmap,counts_heatmap,cluster_idx_heatmap] = dbscan_fcn(x1_heatmap,y1_heatmap,7,1.2);
